...
public class GuiLootEditor extends Gui {
    ...
    public void paint() {
        ...
        setButton(8, GuiUtils.createButtonItem(Material.OAK_DOOR, TextUtils.formatText("&cBack")),
                (event) -> guiManager.showGUI(event.player, returnGui));

        setButton(9, GuiUtils.createButtonItem(loot.getMaterial() == null ? Material.BARRIER : loot.getMaterial(),
            ...
            loot.setMaterial(stack.getType());

            paint();
        });

        /* setButton(10, GuiUtils.createButtonItem(Material.PAPER,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, loot.getName()));
                }); */

        setButton(11, GuiUtils.createButtonItem(Material.WRITABLE_BOOK,
        ...
        setButton(12, GuiUtils.createButtonItem(Material.ENCHANTED_BOOK,
        ...
        setButton(13, GuiUtils.createButtonItem(
                ...
                (event) -> {
                    ItemStack stack = event.player.getInventory().getItemInMainHand();
                    loot.setBurnedMaterial(stack.getType());

                    paint();
                });

        /* setButton(14, GuiUtils.createButtonItem(Material.CLOCK,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getChance())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(15, GuiUtils.createButtonItem(Material.REDSTONE,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER,
                            String.valueOf(loot.getMin())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(16, GuiUtils.createButtonItem(Material.GLOWSTONE_DUST,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getMax())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(17, GuiUtils.createButtonItem(Material.REDSTONE,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getDamageMin())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(18, GuiUtils.createButtonItem(Material.GLOWSTONE_DUST,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getDamageMax())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(19, GuiUtils.createButtonItem(Material.CHEST,
        ...
        setButton(20, GuiUtils.createButtonItem(Material.REDSTONE,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getChildDropCountMin())));
                    guiManager.showGUI(event.player, gui);
                });

        setButton(21, GuiUtils.createButtonItem(Material.GLOWSTONE_DUST,
                ...
                (event) -> {
                    ...
                    gui.setInput(GuiUtils.createButtonItem(Material.PAPER, String.valueOf(loot.getChildDropCountMax())));
                    guiManager.showGUI(event.player, gui);
                });
        ...
        setButton(22, GuiUtils.createButtonItem(Material.ENCHANTED_BOOK,
        ...
        /* setButton(4, 0, GuiUtils.createButtonItem(Material.LIME_DYE, TextUtils.formatText("&aCreate new Child Loot")),
                (event -> {
                    AnvilGui gui = new AnvilGui(event.player, this);

                    gui.setAction((event1 -> {
                        try {
                            loot.addChildLoots(new LootBuilder().setMaterial(Material.valueOf(gui.getInputText().trim())).build());
