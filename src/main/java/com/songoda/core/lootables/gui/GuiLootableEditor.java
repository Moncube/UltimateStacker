...
public class GuiLootableEditor extends Gui {
    ...
    private void paint() {
        ...
        /* setButton(0, GuiUtils.createButtonItem(Material.LIME_DYE, TextUtils.formatText("&aCreate new Loot")),
                (event -> {
                    AnvilGui gui = new AnvilGui(event.player, this);
                    gui.setAction((event1 -> {
                        try {
                            lootable.registerLoot(new LootBuilder().setMaterial(Material
