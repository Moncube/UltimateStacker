...
public class ConfigEditorGui extends SimplePagedGui {
    ...
    protected ConfigEditorGui(Player player, JavaPlugin plugin, Gui parent, String file, MemoryConfiguration config, ConfigurationSection node) {
        ...
        for (final String settingKey : settings) {
            ...
            if (val instanceof Boolean) {
                // toggle switch
                setButton(index, configItem(Material.LEVER, ChatColor.YELLOW + settingKey, node, settingKey, String.valueOf(val), "Click to toggle this setting"),
                ...
                // number dial
                this.setButton(index, configItem(Material.CLOCK, ChatColor.YELLOW + settingKey, node, settingKey, String.valueOf(val), "Click to edit this setting"),
                        (event) -> {
                            event.gui.exit();
    ...
    void setMaterial(int clickCell, String path, ItemStack item) {
        /*CompatibleMaterial mat = Material.getMaterial(item);
    ...
    private boolean isMaterial(Object value) {
        ...
        return value instanceof String && value.toString().equals(value.toString().toUpperCase())
                && (m = Material.getMaterial(value.toString())) != null && m.isBlock();//m.isValidItem();
    }
