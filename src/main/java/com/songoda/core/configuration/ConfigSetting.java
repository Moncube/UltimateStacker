...
public class ConfigSetting {
    ...
    public Material getMaterial() {
        ...
        Material mat = Material.getMaterial(config.getString(key));
    ...
    @NotNull
    public Material getMaterial(@NotNull Material def) {
        //return config.getMaterial(key, def);
        String val = config.getString(key);
        Material mat = val != null ? Material.getMaterial(val) : null;
